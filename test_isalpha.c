...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/22 16:06:05 by rohoffma          #+#    #+#             */
/*   Updated: 2024/04/23 11:45:42 by rohoffma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_isalpha(void)
{
	...
	printf("--- Tests for ft_isalpha function ---\n");
	test(test1);
	test(test2);
	test(test3);
	test(test4);
	...
	test(test7);
	test(test8);
	printf("--- End of tests for 'ft_isalpha' ---\n\n\n");
}
