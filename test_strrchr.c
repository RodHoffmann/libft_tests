...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/30 13:18:45 by rohoffma          #+#    #+#             */
/*   Updated: 2024/04/30 13:29:15 by rohoffma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_strrchr(void)
{
	...
	const char	s5[] = "Another test without finding this time";
	const char	s6[] = "";
	const char	s7[] = "";
	const char	s8[] = "";
	int	test1;
	...
	printf("--- Tests for ft_strrchr function ---\n");
	test(s1, test1);
	test(s2, test2);
	test(s3, test3);
	test(s4, test4);
	...
	test(s7, test7);
	test(s8, test8);
	printf("--- End of tests for 'ft_strrchr' ---\n\n\n");
}
