...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/30 17:37:37 by rohoffma          #+#    #+#             */
/*   Updated: 2024/04/30 17:50:23 by rohoffma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	void	test(const char *s1, const char *s2, size_t n)
{
	...
	{
		printf("Test for string 1: '%s' and string 2: '%s' with size: '%zu': \033[0;32mPassed\033[0m\n", s1, s2, n);
	}
	else
	{
		printf("Test for string 1: '%s' and string 2: '%s' with size: '%zu': \033[0;31mFailed\033[0m\n", s1, s2, n);
	}
}
...
void	test_memcmp(void)
{
	...
	printf("--- Tests for ft_memcmp function ---\n");
	test(s1_1, s1_2, c1);
	test(s2_1, s2_2, c2);
	test(s3_1, s3_2, c3);
	test(s4_1, s4_2, c4);
	...
	test(s7_1, s7_2, c7);
	test(s8_1, s8_2, c8);
	printf("--- End of tests for 'ft_memcmp' ---\n\n\n");
}
